...
func (tc *TestCaseStructLiteralVal) Setup(*testing.T, context.Context) {
...
func (tc *TestCaseStructLiteralVal) Run(t *testing.T, ctx context.Context) {
	runTest(t, ctx, tc.logs, tc.Log)
}
