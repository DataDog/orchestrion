...
replace github.com/Datadog/dd-trace-go/v2 => github.com/kakkoyun/dd-trace-go/v2 v2.0.0-20250929121641-a619f65c8815

require (
	github.com/DataDog/dd-trace-go/v2 v2.4.0-dev.0.20250929142826-c5f0aeede37a
